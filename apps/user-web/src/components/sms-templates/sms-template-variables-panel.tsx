...
import { SMS_TEMPLATE_VARIABLES } from "@/types/sms-template"

interface SMSTemplateVariablesPanelProps {
  onInsert?: (variable: string) => void
}

export function SMSTemplateVariablesPanel({ onInsert }: SMSTemplateVariablesPanelProps) {
    ...
    <Card>
      ...
      <CardContent className="space-y-2">
        ...
        <div className="space-y-1.5">
          {SMS_TEMPLATE_VARIABLES.map(({ variable, description }) => (
            <div
              key={variable}
