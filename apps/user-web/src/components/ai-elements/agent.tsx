...
export const AgentTools = memo(({ className, type, ...props }: AgentToolsProps) => (
  <div className={cn("space-y-2", className)}>
    <span className="font-medium text-muted-foreground text-sm">Tools</span>
    {/* @ts-expect-error - type needs to be passed first to determine the discriminated union */}
    <Accordion className="rounded-md border" type={type ?? "multiple"} {...props} />
  </div>
));
