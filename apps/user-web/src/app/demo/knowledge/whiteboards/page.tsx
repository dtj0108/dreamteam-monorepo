...
import type { DemoWhiteboard } from "@/lib/demo-data"
...
function sortWhiteboards(whiteboards: DemoWhiteboard[], sortBy: SortOption): DemoWhiteboard[] {
...
export default function DemoWhiteboardsPage() {
  const { whiteboards } = useDemoKnowledge()
        ...
        <Card className="max-w-md">
          <CardContent className="flex flex-col items-center text-center py-8">
            ...
            <p className="text-muted-foreground mb-4">
              Whiteboards are great for brainstorming, diagramming, and visual collaboration.
            </p>
          </CardContent>
        </Card>
      </div>
