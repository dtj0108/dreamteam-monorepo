...
import { TemplateEditorForm, TemplateEditorFormRef } from "@/components/email-templates"
...
export default function TemplateEditorPage({ params }: TemplateEditorPageProps) {
  ...
  const formRef = useRef<TemplateEditorFormRef>(null)
      ...
      <div className="p-6">
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <Button onClick={() => router.push("/sales/templates")}>
              Back to Templates
            </Button>
          </CardContent>
        </Card>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push("/sales/templates")}
          >
