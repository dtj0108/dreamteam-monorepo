...
export function WorkspaceInviteEmail({
  ...
  return (
    <Html>
      ...
      <Preview>{inviterName} invited you to join {workspaceName} on DreamTeam</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            ...
            <Text style={heroTitle}>You're invited!</Text>
          </Section>
          ...
          <Section style={messageSection}>
            <Text style={messageText}>
              ...
              <strong>{workspaceName}</strong> on DreamTeam as a {role}.
            </Text>
          </Section>
